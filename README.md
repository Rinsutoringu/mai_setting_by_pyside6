...
这是凛娴尝试自行开发pyside6的托管仓库

因为这个b住在校外，而这个项目会同时在家里的电脑和学校的电脑上开发，天天背着笔记本上学不现实，会累似

所以必须得有个同步方法来维持本项目的日常开发

...于是就有了这个仓库

我直接fork了一份教程，~~这样就不需要自己配环境了~~

底下就是单纯的教程，我的工程在 `Project\my_project` 路径下，纯萌新，大佬勿喷呜呜
